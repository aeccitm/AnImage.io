...
% Last Modified by GUIDE v2.5 11-Apr-2023 09:21:49
...
CST.addNormalMaterial('FR4',4.3,1,[1 0.8 0.6]);
CST.addNormalMaterial('PTFE',2.1,1,[1 0.5 0.5]);

Z2=[0 -3*z];
Z3=[z -3*z];
CST.addBrick([-w/2 w/2]+(w/2+cc)*escala,[-w/2 w/2]+(w/2+cc)*escala,[0 z],'Brick1','Component1','FR4');
CST.addBrick([-w/2 w/2]+(w/2+cc)*escala,[-w/2 w/2]+(w/2+cc)*escala,[0 -z1/2],'Tierra','Component1','Copper (annealed)');
